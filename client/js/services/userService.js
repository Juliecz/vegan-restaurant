    ...
    .factory('userFactory', function ($http) {
        return {
            ...
            updateUser: function (id, formData) {
                return $http.put('/api/user/'+id, {id: id, username: formData.uzivJm, name: formData.jm, surname: formData.prijm, role: formData.role, email: formData.email, phone: formData.phone, emailMessage: formData.emailMTmp, password: formData.password });
            }
        };
    });